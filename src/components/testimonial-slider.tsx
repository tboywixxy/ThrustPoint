...
const testimonials = [
  ...
  },
  {
    ...
    name: "Abena Kwarteng",
    role: "Finance Manager, Onda House",
    initials: "AK",
        ...
        {testimonials.map((testimonial, index) => (
          <article className="testimonial-card" key={testimonial.name}>
            ...
            <div className="testimonial-author">
              <span className="author-initials" aria-hidden="true">{testimonial.initials}</span>
              <div>
